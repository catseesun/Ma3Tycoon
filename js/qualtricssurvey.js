// (C) 2007-2016 Qualtrics, Inc.
/****************************************
This script is to collect feedback through 
...
var popup_x=document.createElement('img');this.setStyle(popup_x,{width:'30px',height:'30px',position:'absolute',top:closeY+'px',right:closeX+'px',cursor:'pointer',zIndex:'20001'});popup_x.src=this.options.imagePath+"/black_popup_x.png";popup_x=this.fixPNG(popup_x,30,30);popup_x.onclick=function(){that.close();};var popup_body=document.createElement('div');this.setStyle(popup_body,{position:'absolute',textAlign:'center',fontFamily:'Helvetica', color:'gray', fontSize:'12pt',zIndex:'20001'});popup_body.appendChild(popupText);popup_body.appendChild(surveyLink);if(!hideDropShadow)
